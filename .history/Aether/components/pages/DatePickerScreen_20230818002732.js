  ...
  return (
    ...
    <View style={styles.container}>
      <View style={{ flex: 0.3,flexDirection: 'row', alignItems: "center", justifyContent: "center" , padding: 10}}>
        <TouchableOpacity style={[defultBoxStyle.container,{margin: 5, padding:0 , marginTop:0, marginBottom}]}>
          <Text style={[styles.textStyle,{textAlign: 'center',}]}>
            Current Date
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={[defultBoxStyle.container,{margin: 5, padding:0}]}>
          <Text style={[styles.textStyle,{textAlign: 'center',}]}>
            Current Date
          </Text>
        </TouchableOpacity>
